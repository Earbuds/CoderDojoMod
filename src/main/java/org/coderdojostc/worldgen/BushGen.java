...
public class BushGen extends WorldGenerator {
	    ...
	    public BushGen(int meta, int range)
	    {
	        metadata = meta;
	        spawnHeight = range;
	    }
	    ...
	    int findGround (World world, int x, int y, int z)
	    {
	        ...
	        do
	        {
	            if (height < 64) // If height is less than sea level (64)
	            {
	                break;
	            }
	    ...
	    void generateBerryBlock (World world, int x, int y, int z, Random random)
	    {
	        if (!world.getBlock(x, y, z).isOpaqueCube())
	        {
	            ...
	            world.setBlock(x, y, z, CDBlocks.blockBush, metadata + 8 + metaOffset * 4, 0);
	        }
	    }
	    ...
	    void generateBerryBush (World world, int x, int y, int z, Random random)
	    {
	        if (!world.getBlock(x, y, z).isOpaqueCube())
	        {
	            ...
	            world.setBlock(x, y, z, CDBlocks.blockBush, metadata + metaOffset * 4, 0);
	        }
	    }
